...
<head>
	...
	<title>Konfirmasi Password Baru - SAS SMK Taruna Bakti Kertosono</title>
...
<body>
	...
	<div class="d-flex min-vh-100 justify-content-center align-items-center" style="position:relative;z-index:1;">
		<div class="confirm-card text-center">
			...
			<h5 class="confirm-title mb-2">Konfirmasi Password Baru</h5>
			<p class="confirm-desc text-start">
				Silakan masukkan password baru Anda, lalu konfirmasi password untuk menyelesaikan proses reset.
			</p>
			...
			<form method="POST" action="{{ route('password.confirm.update') }}">
				...
				<button type="submit" class="btn btn-save w-100 py-2">Simpan Password Baru</button>

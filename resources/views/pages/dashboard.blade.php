...
<head>
    ...
    <!-- Title -->
    <title>Dasboard - SAS SMK Taruna Bakti Kertosono</title>

    <!-- Theme Color -->
    <meta name="theme-color" content="#6366f1">

    <!-- PWA Manifest -->
    <link rel="manifest" href="{{ asset('manifest-DTaoG9pG.json') }}">
    <script type="module" crossorigin src="{{ asset('assets/main-BPhDq89w.js') }}"></script>
    <link rel="stylesheet" href="{{ asset('assets/main-D9K-blpF.css') }}">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom">
                <div class="container-fluid">
                    ...
                    <a class="navbar-brand d-flex align-items-center" href="{{ route('dashboard.index') }}">
                        <img src="{{ asset('image/smk-taruna-bakti.png') }}" alt="Logo SMK Taruna Bakti" style="width:60px;height:50px;object-fit:contain;">
                        <h1 class="h4 mb-0 fw-bold text-education">SAS</h1>
                    </a>
            ...
            <div class="container-fluid p-4 p-lg-5">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <p class="text-muted mb-0">Selamat Datang Admin SAS SMK Taruna Bakti Kertosono.</p>
                    </div>

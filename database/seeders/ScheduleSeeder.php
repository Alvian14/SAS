...
class ScheduleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $subjects = [
            ['id' => 1, 'code' => 'MTK', 'name' => 'Matematika', 'start' => 1, 'end' => 2],
            ['id' => 2, 'code' => 'SENBUD', 'name' => 'Seni Kebudayaan', 'start' => 3, 'end' => 3],
            ['id' => 3, 'code' => 'SEJ', 'name' => 'Sejarah', 'start' => 4, 'end' => 5],
            ['id' => 4, 'code' => 'BD', 'name' => 'Bahasa Daerah', 'start' => 6, 'end' => 6],
        ...
        foreach ($subjects as $subject) {
            ...
            $rawCode = "{$className}-" . strtoupper(substr($day, 0, 3)) . "-{$subject['start']}-{$subject['end']}-{$subject['code']}-{$token}";
